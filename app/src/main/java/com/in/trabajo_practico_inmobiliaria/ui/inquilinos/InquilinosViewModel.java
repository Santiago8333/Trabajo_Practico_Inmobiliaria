    ...
    public void obtenerListaInmueblesContratoVigente(){
        ...
        call.enqueue(new Callback<List<Inmueble>>() {
            ...
            public void onResponse(Call<List<Inmueble>> call, Response<List<Inmueble>> response) {
                if(response.isSuccessful()){
                    ...
                    try{
                        ...
                        Log.d("ErrorInquilinos", "codigo: " + response.code());
                        Log.d("ErrorInquilinos", "mensaje: " + response.message());
                        Log.d("ErrorInquilinos", "body: " + response.errorBody().string());

                    }catch (Exception e){
                        Log.d("ErrorInquilinos",e.toString());
                    }
            ...
            public void onFailure(Call<List<Inmueble>> call, Throwable t) {
                Log.d("ErrorInquilinos",t.getMessage());
            }
        });
